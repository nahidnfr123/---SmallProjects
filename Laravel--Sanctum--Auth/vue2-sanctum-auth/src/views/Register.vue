    ...
    <div class="py-8 px-8 rounded-xl">
      ...
      <form action="" class="mt-6">
        <div class="my-5 text-sm">
          ...
          <input type="text" autofocus id="name" class="rounded-sm px-4 py-3 mt-3 focus:outline-none bg-gray-100 w-full" placeholder="Username" />
        </div>

        <div class="my-5 text-sm">
          <label for="email" class="block text-black">Email:</label>
          <input type="email" autofocus id="email" class="rounded-sm px-4 py-3 mt-3 focus:outline-none bg-gray-100 w-full" placeholder="Username" />
        </div>
